 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.impl.NumberOfRelationStrategyImpl#isActiveStrategy <em>Active
 * Strategy</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.NumberOfRelationStrategyImpl#getStyleDetailled <em>Style
 * Detailled</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.NumberOfRelationStrategyImpl#getStyleNormal <em>Style
 * Normal</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.NumberOfRelationStrategyImpl#getStyleSummarized <em>Style
 * Summarized</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumberOfRelationStrategyImpl extends MinimalEObjectImpl.Container implements NumberOfRelationStrategy {
    /**
    ...
    public void setActiveStrategy(boolean newActiveStrategy) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.NUMBER_OF_RELATION_STRATEGY__ACTIVE_STRATEGY, oldActiveStrategy, this.activeStrategy));
    }
    ...
    public NotificationChain basicSetStyleDetailled(NodeStyleDescription newStyleDetailled, NotificationChain msgs) {
        ...
        if (this.eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ViewPackage.NUMBER_OF_RELATION_STRATEGY__STYLE_DETAILLED, oldStyleDetailled, newStyleDetailled);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setStyleDetailled(NodeStyleDescription newStyleDetailled) {
        if (newStyleDetailled != this.styleDetailled) {
            ...
            if (this.styleDetailled != null)
                msgs = ((InternalEObject) this.styleDetailled).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ViewPackage.NUMBER_OF_RELATION_STRATEGY__STYLE_DETAILLED, null, msgs);
            if (newStyleDetailled != null)
                msgs = ((InternalEObject) newStyleDetailled).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ViewPackage.NUMBER_OF_RELATION_STRATEGY__STYLE_DETAILLED, null, msgs);
            msgs = this.basicSetStyleDetailled(newStyleDetailled, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.NUMBER_OF_RELATION_STRATEGY__STYLE_DETAILLED, newStyleDetailled, newStyleDetailled));
    }
    ...
    public NotificationChain basicSetStyleNormal(NodeStyleDescription newStyleNormal, NotificationChain msgs) {
        ...
        if (this.eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ViewPackage.NUMBER_OF_RELATION_STRATEGY__STYLE_NORMAL, oldStyleNormal, newStyleNormal);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setStyleNormal(NodeStyleDescription newStyleNormal) {
        if (newStyleNormal != this.styleNormal) {
            ...
            if (this.styleNormal != null)
                msgs = ((InternalEObject) this.styleNormal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ViewPackage.NUMBER_OF_RELATION_STRATEGY__STYLE_NORMAL, null, msgs);
            if (newStyleNormal != null)
                msgs = ((InternalEObject) newStyleNormal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ViewPackage.NUMBER_OF_RELATION_STRATEGY__STYLE_NORMAL, null, msgs);
            msgs = this.basicSetStyleNormal(newStyleNormal, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.NUMBER_OF_RELATION_STRATEGY__STYLE_NORMAL, newStyleNormal, newStyleNormal));
    }
    ...
    public NotificationChain basicSetStyleSummarized(NodeStyleDescription newStyleSummarized, NotificationChain msgs) {
        ...
        if (this.eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ViewPackage.NUMBER_OF_RELATION_STRATEGY__STYLE_SUMMARIZED, oldStyleSummarized, newStyleSummarized);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setStyleSummarized(NodeStyleDescription newStyleSummarized) {
        if (newStyleSummarized != this.styleSummarized) {
            ...
            if (this.styleSummarized != null)
                msgs = ((InternalEObject) this.styleSummarized).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ViewPackage.NUMBER_OF_RELATION_STRATEGY__STYLE_SUMMARIZED, null, msgs);
            if (newStyleSummarized != null)
                msgs = ((InternalEObject) newStyleSummarized).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ViewPackage.NUMBER_OF_RELATION_STRATEGY__STYLE_SUMMARIZED, null, msgs);
            msgs = this.basicSetStyleSummarized(newStyleSummarized, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.NUMBER_OF_RELATION_STRATEGY__STYLE_SUMMARIZED, newStyleSummarized, newStyleSummarized));
    }
