...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Empty Node Style Description</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.impl.EmptyNodeStyleDescriptionImpl#getFontSize <em>Font Size</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.EmptyNodeStyleDescriptionImpl#isItalic <em>Italic</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.EmptyNodeStyleDescriptionImpl#isBold <em>Bold</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.EmptyNodeStyleDescriptionImpl#isUnderline <em>Underline</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.EmptyNodeStyleDescriptionImpl#isStrikeThrough <em>Strike
 * Through</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.EmptyNodeStyleDescriptionImpl#getBorderColor <em>Border
 * Color</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.EmptyNodeStyleDescriptionImpl#getBorderRadius <em>Border
 * Radius</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.EmptyNodeStyleDescriptionImpl#getBorderSize <em>Border
 * Size</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.EmptyNodeStyleDescriptionImpl#getBorderLineStyle <em>Border Line
 * Style</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.EmptyNodeStyleDescriptionImpl#getLabelColor <em>Label
 * Color</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.EmptyNodeStyleDescriptionImpl#getWidthComputationExpression
 * <em>Width Computation Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.EmptyNodeStyleDescriptionImpl#getHeightComputationExpression
 * <em>Height Computation Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.EmptyNodeStyleDescriptionImpl#isShowIcon <em>Show Icon</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EmptyNodeStyleDescriptionImpl extends StyleImpl implements EmptyNodeStyleDescription {
    /**
     ...
     * @generated
     */
    protected EmptyNodeStyleDescriptionImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return ViewPackage.Literals.EMPTY_NODE_STYLE_DESCRIPTION;
    }
    ...
    public void setFontSize(int newFontSize) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__FONT_SIZE, oldFontSize, this.fontSize));
    }
    ...
    public void setItalic(boolean newItalic) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__ITALIC, oldItalic, this.italic));
    }
    ...
    public void setBold(boolean newBold) {
        ...
        this.bold = newBold;
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__BOLD, oldBold, this.bold));
    }
    ...
    public void setUnderline(boolean newUnderline) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__UNDERLINE, oldUnderline, this.underline));
    }
    ...
    public void setStrikeThrough(boolean newStrikeThrough) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__STRIKE_THROUGH, oldStrikeThrough, this.strikeThrough));
    }
    ...
    public UserColor getBorderColor() {
        if (this.borderColor != null && this.borderColor.eIsProxy()) {
            ...
            if (this.borderColor != oldBorderColor) {
                if (this.eNotificationRequired())
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE, ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__BORDER_COLOR, oldBorderColor, this.borderColor));
            }
        }
    ...
    public void setBorderColor(UserColor newBorderColor) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__BORDER_COLOR, oldBorderColor, this.borderColor));
    }
    ...
    public void setBorderRadius(int newBorderRadius) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__BORDER_RADIUS, oldBorderRadius, this.borderRadius));
    }
    ...
    public void setBorderSize(int newBorderSize) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__BORDER_SIZE, oldBorderSize, this.borderSize));
    }
    ...
    public void setBorderLineStyle(LineStyle newBorderLineStyle) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__BORDER_LINE_STYLE, oldBorderLineStyle, this.borderLineStyle));
    }
    ...
    public UserColor getLabelColor() {
        if (this.labelColor != null && this.labelColor.eIsProxy()) {
            ...
            if (this.labelColor != oldLabelColor) {
                if (this.eNotificationRequired())
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE, ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__LABEL_COLOR, oldLabelColor, this.labelColor));
            }
        }
    ...
    public void setLabelColor(UserColor newLabelColor) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__LABEL_COLOR, oldLabelColor, this.labelColor));
    }
    ...
    public void setWidthComputationExpression(String newWidthComputationExpression) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__WIDTH_COMPUTATION_EXPRESSION, oldWidthComputationExpression,
    ...
    public void setHeightComputationExpression(String newHeightComputationExpression) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__HEIGHT_COMPUTATION_EXPRESSION, oldHeightComputationExpression,
    ...
    public void setShowIcon(boolean newShowIcon) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__SHOW_ICON, oldShowIcon, this.showIcon));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__FONT_SIZE:
                return this.getFontSize();
            case ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__ITALIC:
                return this.isItalic();
            case ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__BOLD:
                return this.isBold();
            case ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__UNDERLINE:
                return this.isUnderline();
            case ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__STRIKE_THROUGH:
                return this.isStrikeThrough();
            case ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__BORDER_COLOR:
                if (resolve)
                    return this.getBorderColor();
                return this.basicGetBorderColor();
            case ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__BORDER_RADIUS:
                return this.getBorderRadius();
            case ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__BORDER_SIZE:
                return this.getBorderSize();
            case ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__BORDER_LINE_STYLE:
                return this.getBorderLineStyle();
            case ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__LABEL_COLOR:
                if (resolve)
                    return this.getLabelColor();
                return this.basicGetLabelColor();
            case ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__WIDTH_COMPUTATION_EXPRESSION:
                return this.getWidthComputationExpression();
            case ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__HEIGHT_COMPUTATION_EXPRESSION:
                return this.getHeightComputationExpression();
            case ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__SHOW_ICON:
        ...
        if (baseClass == LabelStyle.class) {
            switch (baseFeatureID) {
                case ViewPackage.LABEL_STYLE__FONT_SIZE:
                    return ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__FONT_SIZE;
                case ViewPackage.LABEL_STYLE__ITALIC:
                    return ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__ITALIC;
                case ViewPackage.LABEL_STYLE__BOLD:
                    return ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__BOLD;
                case ViewPackage.LABEL_STYLE__UNDERLINE:
                    return ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__UNDERLINE;
                case ViewPackage.LABEL_STYLE__STRIKE_THROUGH:
                    return ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__STRIKE_THROUGH;
                default:
                    return -1;
            }
        }
        if (baseClass == BorderStyle.class) {
            switch (baseFeatureID) {
                case ViewPackage.BORDER_STYLE__BORDER_COLOR:
                    return ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__BORDER_COLOR;
                case ViewPackage.BORDER_STYLE__BORDER_RADIUS:
                    return ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__BORDER_RADIUS;
                case ViewPackage.BORDER_STYLE__BORDER_SIZE:
                    return ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__BORDER_SIZE;
                case ViewPackage.BORDER_STYLE__BORDER_LINE_STYLE:
                    return ViewPackage.EMPTY_NODE_STYLE_DESCRIPTION__BORDER_LINE_STYLE;
                default:
                    return -1;
            }
        }
